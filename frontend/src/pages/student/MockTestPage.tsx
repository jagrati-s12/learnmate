      ...
      <>
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="text-center py-12">
            ...
            <p className="text-theme-text-secondary">Loading mock test...</p>
          </div>
        </div>
      </>
    );
      ...
      <div className="flex-1 overflow-hidden p-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
          ...
          <div className="lg:col-span-2 overflow-auto">
            {questions.length > 0 ? (
              <div className="bg-theme-bg-secondary border border-[rgba(243,237,227,0.08)] rounded-xl p-8">
                <div className="flex justify-between items-center pb-4 mb-6 border-b border-[rgba(243,237,227,0.08)]">
                  ...
                  <span className="bg-theme-bg-elevated text-theme-accent-primary px-3 py-1 rounded-md text-sm font-medium">
                    1 mark
                  </span>
                </div>
          ...
          {/* Question Palette */}
          <div className="bg-theme-bg-secondary border border-[rgba(243,237,227,0.08)] rounded-xl p-6 overflow-auto">
            {/* Timer */}
            ...
            <div className="mb-4 space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-theme-bg-secondary border border-theme-border rounded"></div>
              ...
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 border-2 border-blue-500 bg-theme-bg-elevated rounded"></div>
                <span>Current (1)</span>
              </div>
            </div>
                ...
                return (
                  <button
                    ...
                    className={`aspect-square border rounded text-sm font-medium ${
                      isCurrent
                        ? 'border-2 border-blue-500 bg-theme-bg-elevated text-theme-accent-primary'
                        : isAnswered
