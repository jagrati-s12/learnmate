  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-auto p-6">
        <button className="mb-4 text-theme-accent-primary" onClick={() => navigate(`/exams/${branch?.exam_id}/branches`)}>&larr; Back to Branches</button>
          ...
          {subjects.map((subject) => (
            ...
            >
              <CardBody>
                ...
                <p className="text-sm text-theme-text-secondary mt-2">{subject.chapters?.length || 0} chapters</p>
              </CardBody>
            </Card>
          ))}
        </div>
