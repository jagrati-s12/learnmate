...
export default function AITutor() {
  ...
  return (
    <div className="page flex flex-col items-center max-w-5xl mx-auto min-h-[80vh] py-6 px-4">
      {/* Header UI */}
      <div className="w-full text-center px-4 py-8 bg-theme-bg-secondary rounded-t-2xl border border-gray-100 shadow-sm z-10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left max-w-4xl mx-auto">
          <div className="p-4 rounded-xl bg-theme-bg-surface border border-gray-100">
      ...
      <section className="flex flex-col w-full shadow-sm border border-t-0 border-gray-100 rounded-b-2xl rounded-t-none -mt-3 relative z-0" style={{ backgroundColor: 'var(--bg-card)', height: '500px' }}>
        <div className="chat-messages flex-1 overflow-y-auto p-4 flex flex-col gap-4">
          {messages.map((message, index) => (
            <div className={lex } key={index}>
              <div
          ...
          {loading && (
            <div className="flex justify-start">
               <div className="max-w-[80%] rounded-2xl px-4 py-3 bg-theme-bg-surface border border-gray-100 text-theme-text-primary rounded-bl-none flex items-center gap-2">
        ...
        <div className="chat-input p-4 border-t border-gray-100 flex gap-2 bg-theme-bg-secondary rounded-b-2xl">
          <input
            className="flex-1 px-4 py-3 border border-gray-100 bg-theme-bg-surface text-theme-text-primary placeholder-theme-text-muted rounded-full outline-none focus:border-theme-accent-primary focus:ring-1 focus:ring-theme-accent-primary transition-all"
            value={input}
