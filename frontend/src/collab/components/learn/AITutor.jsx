...
export default function AITutor() {
  return (
    <div className="page flex items-center justify-center min-h-[80vh]">
      <div className="max-w-2xl w-full text-center px-6 py-12 bg-theme-bg-secondary rounded-2xl border border-gray-100 shadow-sm">
        ...
        <p className="text-theme-text-secondary text-lg mb-10 max-w-lg mx-auto leading-relaxed">
        ...
        <div className="inline-block bg-theme-bg-elevated border border-blue-100 px-6 py-3 rounded-full">
